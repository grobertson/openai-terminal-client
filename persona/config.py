...
class Settings:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Configuration loaded from: {self.config_filename} bound to Conf.logger"
        )
        self.proto = "https"
        ...
        self.personas = self.scan_personas(self.persona_full_path)
            ...
            try:
                ...
                with open(filename, "r", encoding="utf-8") as f:
                    ...
                    if not persona:
                        if self.debug:
                            logger.error(
                                " ".join(["Invalid persona file detected!: ", filename])
                            )
                    else:
                ...
                print(f'Error while parsing persona! : {filename}\n')
                print(err)
        return personas
